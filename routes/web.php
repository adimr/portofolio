...
Route::get('/auth/{provider}/redirect',[authController::class, "redirect"])->middleware('guest');
Route::get('/auth/{provider}/callback', [authController::class, "callback"])->middleware('guest');

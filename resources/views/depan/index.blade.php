    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">
            ...
            <span class="d-none d-lg-block"><img class="img-fluid img-profile rounded-circle mx-auto mb-2"
                    src="{{ asset('foto') . '/' . get_meta_velue('_foto') }}" alt="..." /></span>
        </a>
        ...
        <section class="resume-section" id="about">
            <div class="resume-section-content">
                ...
                <div class="subheading mb-5">
                    {{ get_meta_velue('_kota') }} · {{ get_meta_velue('_provinsi') }} · {{ get_meta_velue('_nohp') }} ·
                    <a href="{{ get_meta_velue('_email') }}">{{ get_meta_velue('_email') }}</a>
                </div>
                <div class="lead mb-5">{!! $about->isi !!}</div>
                <div class="social-icons">
                    <a class="social-icon" href="{{ get_meta_velue('_linkedin') }}"><i
                            class="fab fa-linkedin-in"></i></a>
                    <a class="social-icon" href="{{ get_meta_velue('_github') }}"><i class="fab fa-github"></i></a>
                    <a class="social-icon" href="{{ get_meta_velue('_twitter') }}"><i class="fab fa-twitter"></i></a>
                    <a class="social-icon" href="{{ get_meta_velue('_facebook') }}"><i
        ...
        <section class="resume-section" id="skills">
            <div class="resume-section-content">
                ...
                <ul class="list-inline dev-icons">
                    @foreach (explode(', ', get_meta_velue('_skill')) as $item)
                        <li class="list-inline-item"><i class="devicon-{{ strtolower($item) }}-plain"></i></li>
                    @endforeach
                </ul>
                <div class="subheading mb-3">Workflow</div>
                {!! set_list_workflow(get_meta_velue('_workflow')) !!}
            </div>
        </section>
        <hr class="m-0" />
        <!-- Interests-->

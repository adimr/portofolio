...
class educationController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate(
            [
                ...
                'info1.required'=> 'Jenjang Pendidikan Wajib diisi',
                'info2.required'=> 'Nama Jurusan Wajib diisi',
                'info3.required'=> 'Nilai IPK Wajib diisi',
                'tgl_mulai.required'=> 'Tanggal Wajib diisi',
            ]
            );
            ...
            return redirect()->route('education.index')->with('success','EDUCATION TELAH DI TAMBAHKAN');
    }
    ...
    public function update(Request $request, $id)
    {
        $request->validate(
            ...
            return redirect()->route('education.index')->with('success','EDUCATION DATA BERHASIL DI UBAH');
    }
